...
function App() {
  ...
  const [messages, setMessage] = useState("6");
  const participantsRef = React.useRef(messages);
  console.log("init");

  // function sendMessage(event, valueText) {
  //   let newData = messages.concat(valueText);
  //   setMessage([]);
  //   // event.preventDefault();
  //   // socket.emit("all client", valueText);
  // }
  const handler = (data, setMessagetmp, mess) => {
    // Update coordinates
    console.log("newData", data);
    console.log("messages", mess);
    console.log("setMessagetmp", setMessagetmp);
  ...
  React.useEffect(() => {
    ...
    participantsRef.current = messages;
  });
  useEffect(() => {
    // function onData(data) {
    //   handler(data, setMessage, messages);
    // }
    const h = (data) => {
      console.log(data);
                    ...
                    <div className="list-group" id="chats" role="tablist">
                      ...
                      >
                        ...
                        <div className="data">
                          ...
                          <span>Mon</span>
                          <p>
                            No more running out of the office at 4pm on Fridays!
                          </p>
                        </div>
                      </a>
                      <a
                      ...
                      >
                        ...
                        <div className="data">
                          ...
                          <span>Thu</span>
                          <p>
                            Unfortunately your session today has been cancelled!
                          </p>
                        </div>
                      </a>
                    </div>
                ...
                <div id="notifications" className="tab-pane fade">
                  <div className="search">
                    <form className="form-inline position-relative">
                      ...
                      />
                      <button type="button" className="btn btn-link loop">
                        <i className="material-icons filter-list">
                          filter_list
                        </i>
                      </button>
                    </form>
                  ...
                  <div className="settings">
                    ...
                    <div className="categories" id="accordionSettings">
                      ...
                      <div className="category">
                        ...
                        >
                          <i className="material-icons md-30 online">
                            person_outline
                          </i>
                          <div className="data">
                            <h5>My Account</h5>
                          ...
                          <div className="content no-layer">
                            <div className="set">
                              <div className="details">
                                ...
                                <p>
                                  You can set up Swipe to receive notifications
                            ...
                            <div className="set">
                              <div className="details">
                                ...
                                <p>
                                  If enabled shows a red badge on the Swipe app
                ...
                <form>
                  ...
                  <div className="form-group">
                    ...
                    <textarea
                      ...
                      id="message"
                      placeholder="Send your welcome message..."
                      defaultValue={"Hmm, are you friendly?"}
                    />
                  </div>
                  <button type="submit" className="btn button w-100">
                    Start New Chat
                      ...
                      <div className="inside">
                        ...
                        <div className="dropdown">
                          ...
                          <div className="dropdown-menu dropdown-menu-right">
                            ...
                            <button className="dropdown-item">
                              <i className="material-icons">block</i>Block
                              Contact
                            </button>
                            <button className="dropdown-item">
                    ...
                    <div className="col-md-12">
                      <div className="inside">
                        ...
                        <div className="dropdown">
                          ...
                          <div className="dropdown-menu dropdown-menu-right">
                            <button className="dropdown-item connect" name={2}>
                              <i className="material-icons">phone_in_talk</i>
                              Voice Call
                            </button>
                            <button className="dropdown-item connect" name={2}>
                    ...
                    <div className="col-md-12">
                      <div className="inside">
                        <div className="panel">
                          ...
                          <button className="btn back" name={2}>
                            <i className="material-icons md-24">chat</i>
                          </button>
                        </div>
                      </div>
                  ...
                  <div className="container">
                    <div className="col-md-12">
                      <div className="inside">
                        ...
                        <button
                          className="btn disabled d-md-block d-none"
                          disabled
                        >
                          <i className="material-icons md-30">phone_in_talk</i>
                        </button>
                        ...
                        <button
                          className="btn d-md-block disabled d-none"
                          disabled
                        >
                          <i className="material-icons md-30">info</i>
                        </button>
                    ...
                    <div className="bottom">
                      <form className="position-relative w-100">
                        <textarea
                          ...
                          defaultValue={""}
                        />
                        <button className="btn emoticons disabled" disabled>
                          <i className="material-icons">insert_emoticon</i>
                        </button>
                        <button className="btn send disabled" disabled>
                          <i className="material-icons">send</i>
                        </button>
                      </form>
                      <label>
                        <input type="file" disabled />
                        <span className="btn attach disabled d-sm-block d-none">
                          <i className="material-icons">attach_file</i>
                        </span>
                      </label>
                    </div>
