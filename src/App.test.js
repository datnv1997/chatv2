...
class App extends React.Component {
  ...
  componentDidMount() {
    socket.on("dataSocket", function (data) {
    ...
    socket.on("Message", (data) => {
      this.setState({ arrayMsg: [data.totalClient] });
    });
  }
  // useEffect(() => {
  //   socket.on("dataSocket", function (data) {
  ...
  //         event.preventDefault();
  //         let valueInput = document.getElementById("content-chat").value;
  //         sendMessage(event, valueInput);
  //         document.getElementById("content-chat").value = "";
  //       }
  //     });
  //   let temp = socket.on("Message", onData);
  //   return () => {
  ...
  //   arr = newData;
  //   if (arrayMsg.length) setMessage([...newData]);
  ...
  // }, [arrayMsg]);
  render() {
    let totalClientsOnline = `New user joined, ${totalClient} join room`;
